...
const isSafari =
  ...
  /^((?!chrome|chromium|android|crios|edgios|edg).)*safari/i.test(
    navigator.userAgent
  );
  ...
  return (
    <div style={styles.container} className="w-full mx-auto">
      ...
      <Meta name="twitter:card" content={event.me_description} />
      ...
      <Container style={{ padding: "0px", border: 0, paddingBottom: "50px" }}>
        ...
        <div
          style={{
            ...
            paddingTop: isSafari ? "3rem" : "0.5rem",     // 🔹 beda Safari
            paddingBottom: isSafari ? "3rem" : "0.5rem",  // 🔹 beda Safari
          }}
        >
          <iframe
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          ...
          <div style={styles.grid}>
            ...
            <div>
              <h1
                style={{ fontSize: "0.9rem", color: "#999", marginBottom: "10px" }}
              >
            ...
            {/* Right - Other News */}
            <div>
              <div style={styles.otherVideos}>
                <h2 style={styles.otherVideosTitle}>Other Events</h2>
                <div style={styles.otherVideosList}>
                  {otherEvent.map((ev, idx) => (
                    ...
                    >
                      {/* Thumbnail */}
                      <img
                        src={ev.me_image_url ? API_URLIMAGE+"/uploads/events/"+ev.me_image_url : "https://via.placeholder.com/100x60?text=No+Image" }
                        alt={ev.me_name}
                        style={{
                          width: "100px",
                          height: "60px",
