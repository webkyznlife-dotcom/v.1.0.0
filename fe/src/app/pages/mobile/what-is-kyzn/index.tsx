...
import WhatIsKYZNHeader from "../../mobile/what-is-kyzn/components/what-is-kyzn-header";
...
const WhatIsKYZNMobile: React.FC = () => {
  // === Refs & Animation View ===
  ...
  return (
    <div style={styles.container}>
      <Container style={{ padding: 0, border: 0, paddingBottom: "50px" }}>
        ...
        {/* ================= Title + Description ================= */}
        <div ref={sectionRef} className="mt-16 mb-0 px-6 pt-0"> 
          <motion.h2
        ...
        {/* ================= Content + Video ================= */}
        <div className="flex flex-col gap-6 px-4 sm:px-6" style={styles.content}>
          {/* Text Content */}
          <div className="space-y-4 text-gray-700 text-base leading-relaxed" style={styles.paragrafStyle}>
            <p>
          ...
          <Card className="shadow-sm rounded-2xl overflow-hidden">
            ...
            <div className="mt-3 flex flex-col gap-2 px-3 pb-3">
              {/* Progress Bar */}
              <Slider value={progress} onChange={handleSeek} className="!h-2" />
              ...
              <div className="flex items-center justify-between text-xs text-gray-500 mt-1">
                ...
                <div className="flex-1 flex justify-center items-center gap-2">
                  ...
                  <Button
                    ...
                    className="shadow-md !w-6 !h-8 flex items-center justify-center"
                  />
                </div>
        ...
        <div className="w-full mt-0 py-2 pt-5" style={{ backgroundColor: '#fafafa' }}>
          <div ref={coreValueRef} className="w-4/5 mx-auto text-2xl md:text-3xl font-semibold text-gray-900 mb-8 text-center">
            {/* Title */}
            <motion.h2
              className="font-semibold text-xl text-gray-800 px-6 pt-0 mb-1" // mb-1 = margin-bottom 0.25rem
              initial={{ opacity: 0, y: 30 }}
            ...
            <motion.p
              className="text-gray-700 mt-1 text-lg md:text-xl font-normal" // mt-1 = margin-top 0.25rem
              initial={{ opacity: 0, y: 20 }}
              animate={isCoreValueInView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.2 }}
            >
        ...
        <div className="py-4 bg-gray-100">
          <div className="text-center px-4 md:px-0">
            ...
            <p className="text-gray-700 max-w-2xl mx-auto mb-6 text-base md:text-lg">
              At KYZN, we cultivate Family Wellness, creating vibrant communities where families flourish. Beyond fitness, we inspire active, mindful, and lifelong learning experiences.
            </p>

            {/* Horizontal Scroll Timeline */}
            <div className="overflow-x-auto flex gap-4 md:gap-6 py-4 scrollbar-custom scroll-smooth">
              {[
                { year: "2021", text: "Launched our first branch, KYZN BSD, in November." },
                { year: "2022", text: "Achieved 1,500+ members, 1,900+ activities, and welcomed 10,000 visitors monthly." },
                { year: "2023", text: "Opened our second branch, KYZN Kuningan, in May. Introduced The Forge and 30+ new programs." },
                { year: "2024", text: "Reached 3,000+ members, hosted 3,000+ activities, and launched 20+ programs with new facilities." },
                { year: "2025", text: "Exciting new branch coming soon!" },
              ].map((item, index) => (
                <div key={index} className="flex-none w-64 sm:w-72 bg-white rounded-2xl shadow-md p-4 text-center scroll-snap-start">
                  {/* Dot */}
...
export default WhatIsKYZNMobile;
