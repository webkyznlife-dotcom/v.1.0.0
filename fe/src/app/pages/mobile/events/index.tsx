...
import EventsHeaderMobile from "./components/events-header/index";
  ...
  return (
    <div style={styles.container}>
      <Container style={{ padding: 0, border: 0, paddingBottom: "50px" }}>
        {/* ================= Header ================= */}
        <EventsHeaderMobile title="EVENTS" breadcrumb="Home / Events" /> 

        {/* ================= Title + Description ================= */}
        <div ref={sectionRef} className="mt-4 mb-0 px-6 pt-0 w-[80%] mx-auto">
          <motion.h2
        ...
        {/* ================= List Events ================= */}
        <div className="mx-auto max-w-[1200px] w-full mx-auto p-8">
          {loading ? (
              ...
              .map((page, idx, arr) => (
                <React.Fragment key={page}>
                  {idx > 0 && arr[idx - 1] !== page - 1 && (
                    <span className="px-2 py-1 flex-shrink-0">...</span>
                  )}
                  <button
